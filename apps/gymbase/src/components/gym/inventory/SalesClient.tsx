                ...
                return (
                  <React.Fragment key={sale.id}>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm text-muted-foreground">{sale.member?.full_name ?? "—"}</td>
                      ...
                      <td className="px-4 py-3 text-sm text-muted-foreground">{METHOD_LABELS[sale.payment_method]}</td>
                      <td className="px-4 py-3">
                        {itemCount > 0 && (
                          <button
                            type="button"
                    ...
                    {isExpanded && sale.items && (
                      <tr key={`${sale.id}-detail`} style={{ backgroundColor: "var(--sidebar)", borderBottom: "1px solid #1a1a1a" }}>
                            ...
                            <tbody>
                              {sale.items.map((item) => (
                                <tr key={item.id}>
                                  ...
                                  <td className="py-1 text-muted-foreground pr-4">{item.quantity}</td>
                                  <td className="py-1 text-muted-foreground pr-4">{formatPrice(item.unit_price)}</td>
