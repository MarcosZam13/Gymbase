          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs text-muted-foreground uppercase tracking-wider">Monto (CRC)</label>
                <input
                  type="number"
                  step="0.01"
                  min="0"
                  placeholder="15000"
                  {...register("amount")}
                  className="w-full rounded-lg px-3 py-2.5 text-sm text-white bg-background border border-border outline-none focus:border-primary transition-colors"
                />
              ...
              <div className="space-y-1.5">
                ...
                <select
                  {...register("category")}
                  className="w-full rounded-lg px-3 py-2.5 text-sm text-white bg-background border border-border outline-none focus:border-primary transition-colors cursor-pointer"
                >
              ...
              {/* Descripción */}
              <div className="space-y-1.5">
                <label className="text-xs text-muted-foreground uppercase tracking-wider">Descripción (opcional)</label>
                <input
                  type="text"
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  style={{ backgroundColor: "#1A1A1A", color: "#737373", border: "1px solid var(--border)" }}
                >
                  Cancelar
                </button>
              </div>
