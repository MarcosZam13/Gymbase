...
export function OwnerSidebar(): React.ReactElement {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-sidebar border-r border-border flex flex-col h-screen sticky top-0">
      {/* Logo y badge de rol */}
      ...
      <div className="p-4 border-t border-border space-y-1">
        ...
        <button
          ...
          disabled={isPending}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-muted-foreground hover:text-red-400 hover:bg-red-500/5 transition-colors disabled:opacity-50"
        >
          <LogOut size={18} />
          Cerrar sesión
        </button>
